...
def showPic(i):
    if(i<popUpAmount):
        # change the image address to yours respectfully
        loc = "C:/Users/billybob/Documents/hackerman/almighty loaf.jpg"
        img = Image.open(loc)
        img.load()
    ...
    #   root.after(1000-i*100, lambda:showPic(i+1))#makes speed of pop up increase
    #   (replaces line above)
    else:
        return
